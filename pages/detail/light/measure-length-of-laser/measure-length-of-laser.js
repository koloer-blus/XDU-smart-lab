...
//函数
  ...
  calculate(){
    ...
    d_A = (this.Sx(Number(table[1][3]),Number(table[2][3]),Number(table[3][3]),Number(table[4][3]),Number(table[5][3]),Number(table[6][3]),Number(table[7][3]),Number(table[8][3]))).toFixed(2)
    ...
    d_B = (d_yi/(Math.sqrt(3))).toFixed(2)
    d_d = (Math.sqrt(d_A*d_A+d_B*d_B)).toFixed(2)
